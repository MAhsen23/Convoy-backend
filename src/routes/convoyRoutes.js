...
router.get('/recaps', convoyController.listDriveRecaps);
router.get('/stats', convoyController.getUserConvoyStats);
router.post('/join', convoyController.joinByCode);
router.get('/:id/recap', convoyController.getDriveRecap);
router.post('/:id/route', convoyController.uploadDriveRoute);
